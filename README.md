...
3. <https://www.youtube.com/watch?v=c-VAPqNBDRU> - видео для понимания высокоскорстной разводки и ЭМС применительно к проектированию печатных плат

# Полезная литература

1. Папка ./Documents содержи дополнительный материал по созданию печатных плат.
   1. *7 правил проектирования печатных плат* - Позволит избежать базовых ошибок проектирования ошибок
   2. *_Altium Designer_ что делать если проект стал сложным_* - иллюстрирует возможности AD при переходе к иерархичным проектам
